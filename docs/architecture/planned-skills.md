...
- [`skills/kybernetes-verify-run`](../../skills/kybernetes-verify-run/SKILL.md), installed as `kybernetes:verify-run` after scenarios 055-059 established independent rejection and coverage behavior.
- [`skills/kybernetes-capture-learning`](../../skills/kybernetes-capture-learning/SKILL.md), installed as `kybernetes:capture-learning` after scenarios 060-063 established evidence-gated promotion and non-authority.
